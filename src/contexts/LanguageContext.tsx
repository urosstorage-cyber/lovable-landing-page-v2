...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.trust1': '15% off 3-month supply',
    ...
    'quiz.result.high.rec': 'We recommend a 3-month Heparbion Plus protocol to support hepatic recovery and bile flow.',
    ...
    'pricing.tier1.name': 'Flexible Start',
    'pricing.tier1.desc': 'Perfect for trying Heparbion Plus for the first time.',
    'pricing.tier1.cta': 'Start Your Journey',
    'pricing.tier2.name': '3-Month Transformation',
    'pricing.tier2.desc': 'The recommended protocol for meaningful metabolic change.',
    'pricing.tier2.cta': 'Best for Results',
    'pricing.tier2.badge': 'Most Popular',
    'pricing.tier3.name': 'Complete System Reset',
    'pricing.tier3.desc': 'For those committed to long-term liver health and wellness.',
    ...
    'pricing.trustReturns': '30-Day Returns',
  ...
  slo: {
    ...
    'hero.trust1': '15% popust ob 3-mesečni zalogi',
    ...
    'quiz.result.high.rec': 'Priporočamo 3-mesečni protokol Heparbion Plus za podporo okrevanja jeter in pretoka žolča.',
    ...
    'pricing.tier1.name': 'Prilagodljiv začetek',
    'pricing.tier1.desc': 'Popolno za prvi preizkus Heparbion Plus.',
    'pricing.tier1.cta': 'Začnite svojo pot',
    'pricing.tier2.name': '3-mesečna preobrazba',
    'pricing.tier2.desc': 'Priporočen protokol za smiselno presnovno spremembo.',
    'pricing.tier2.cta': 'Najboljši za rezultate',
    'pricing.tier2.badge': 'Najbolj priljubljeno',
    'pricing.tier3.name': 'Celotna obnova sistema',
    'pricing.tier3.desc': 'Za tiste, ki so predani dolgotrajnemu zdravju jeter.',
    'pricing.tier3.cta': 'Največji prihranek',
    'pricing.tier3.badge': 'Najboljša vrednost',
    'pricing.feature.capsules1': '120 kapsul (60-dnevna zaloga)',
    'pricing.feature.capsules3': '360 kapsul (6-mesečna zaloga)',
    'pricing.feature.capsules6': '720 kapsul (12-mesečna zaloga)',
    ...
    'pricing.trustReturns': '30-dnevno vračilo',
