...
const tiers: PricingTier[] = [
  {
    ...
    savings: 0,
    features: [
      '120 vegan capsules (60-day supply)',
      'Full-spectrum botanical formula',
      'Free shipping over €60',
      'GMP & ISO 22000 certified',
    ],
    cta: 'Start Your Journey',
    description: 'Perfect for trying Heparbion Plus for the first time.',
  },
  {
    id: 'heparbion-3',
    ...
    popular: true,
    features: [
      '360 capsules (6-month supply)',
      'Full-spectrum botanical formula',
      'Free EU shipping included',
      'GMP & ISO 22000 certified',
      'Priority customer support',
    ],
    cta: 'Best for Results',
    description: 'The recommended protocol for meaningful metabolic change.',
  },
  {
    id: 'heparbion-6',
    ...
    bottles: 6,
    price: 209.00,
    originalPrice: 269.40,
    perBottle: '34.83',
    savings: 60.40,
    badge: 'Best Value',
    features: [
      '720 capsules (12-month supply)',
      'Full-spectrum botanical formula',
      'Free express EU shipping',
      'GMP & ISO 22000 certified',
      'Priority customer support',
      'Exclusive wellness guide PDF',
    ],
    cta: 'Maximum Savings',
    description: 'For those committed to long-term liver health and wellness.',
  },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-semibold text-white tracking-elegant mb-5">
            Invest in Your{' '}
            <span className="text-shimmer">Liver Health</span>
          </h2>
          <p className="text-base text-white/40 max-w-xl mx-auto">
            Every bundle includes free EU shipping, GMP-certified quality, and our satisfaction commitment.
          </p>
        ...
        <div ref={cardsRef} className="grid md:grid-cols-3 gap-5 lg:gap-6">
          {tiers.map((tier, i) => (
            <div
              key={tier.id}
              className={`relative rounded-3xl transition-all duration-500 scroll-reveal ${
                cardsRevealed ? 'revealed' : ''
              } ${
                tier.popular
                  ? 'bg-white/[0.1] border-2 border-gold-400/30 shadow-xl shadow-gold-400/5'
              ...
              <div className="p-7 md:p-8">
                ...
                <button
                  ...
                  className={`w-full py-3.5 rounded-full text-sm font-medium tracking-wide transition-all duration-300 flex items-center justify-center gap-2 ${
                    tier.popular
                      ? 'btn-glow bg-gold-400 text-emerald-500 hover:bg-gold-300'
                      : 'btn-glow bg-white/10 text-white border border-white/10 hover:bg-white/15 hover:border-white/20'
                  }`}
                >
        ...
        {/* Bottom trust strip */}
        <div
          className={`flex flex-wrap justify-center gap-6 md:gap-10 mt-12 scroll-reveal ${
            cardsRevealed ? 'revealed' : ''
          }`}
