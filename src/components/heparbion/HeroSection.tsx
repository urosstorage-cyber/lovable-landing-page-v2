      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full pt-28 pb-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="order-2 lg:order-1">
            ...
            >
              {t('hero.h1.1')}
              <span className="italic text-emerald-400">{t('hero.h1.italic')}</span>
              {t('hero.h1.2')}
            ...
            >
              ...
              <div className="absolute -bottom-4 -left-4 glass-card rounded-2xl px-4 py-3 animate-float-slow" style={{ animationDelay: '2s' }}>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-[10px] text-emerald-500/50 uppercase tracking-wide">{t('hero.badge2')}</p>
                    <p className="text-xs font-semibold text-emerald-500">{t('hero.badge1')}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          <span className="text-[10px] tracking-wide-elegant text-emerald-500/30 uppercase">{t('hero.discover')}</span>
